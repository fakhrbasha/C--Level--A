...
/*
 write -> write without new line
 writeline -> new write with new line
 ForegroundColor -> change line color 
 Console.ReadKey(); مستني اليوزر يدوس اي حاجة عشان يقفل
 
 variable
(data type) (variable name) = Dec
 var -> فاريابول لنت متعرفش هوا اي
